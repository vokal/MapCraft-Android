...
/**
 * The {@link MultiSourceTileDownloader} loads tiles from an HTTP server. It saves downloaded tiles to an
 ...
 *
 */
public class MultiSourceTileDownloader extends MapTileModuleProviderBase {

        // ===========================================================
        // Constants
        // ===========================================================

        private static final Logger logger = LoggerFactory.getLogger(MultiSourceTileDownloader.class);
        ...
        public MultiSourceTileDownloader(final ITileSource pTileSource) {
                this(pTileSource, null, null);
        }

        public MultiSourceTileDownloader(final ITileSource pTileSource, final IFilesystemCache pFilesystemCache) {
